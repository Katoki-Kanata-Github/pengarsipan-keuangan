        ...
        <div class="flex flex-col items-center justify-center w-full px-4">
            <div class="w-full max-w-lg bg-white/90 backdrop-blur-md rounded-xl shadow-xl p-8">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2 relative">
                            ...
                            <select id="divisi" name="divisi" class="block w-full pl-10 pr-3 bg-white/50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200 appearance-none bg-white cursor-pointer">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="pt-4">
                        <x-primary-button class="w-full flex justify-center py-3 px-4 rounded-lg shadow-lg font-bold text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:scale-[1.02] transition">
                            {{ __('Create Account') }}
                        </x-primary-button>
                    </div>
                    ...
                    <div class="text-center pt-2">
                        <p class="text-sm text-gray-600">
                            Already have an account? <a href="{{ route('login') }}" class="font-bold text-indigo-700 hover:text-indigo-500 transition">Sign in here</a>
                        </p>
                    </div>
                </form>
            </div>
