<aside
    class="w-64 min-h-screen bg-gradient-to-b from-[#003A8F] to-[#002766] text-white shadow-2xl flex flex-col transition-all duration-300 hover:shadow-blue-500/20 relative overflow-hidden">
    ...
    <div
        ...
        <a href="{{ route('dashboard') }}"
            ...
            <div class="relative">
                <div
                    class="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl blur opacity-70 group-hover:opacity-100 transition-opacity">
                </div>
    ...
    <div class="p-4 border-b border-gray-700/50 relative z-10">
        <div
            class="flex items-center space-x-3 p-3 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/30 hover:bg-gray-800/70 transition-all duration-300">
            <div class="relative">
                <div
    ...
    <div class="p-4 border-t border-gray-700/50 relative z-10 mt-auto">
        <div class="p-3 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/30">
            <a href="{{ route('logout') }}"
                ...
                <svg class="w-4 h-4 mr-2 text-gray-400 group-hover:text-red-400" fill="none" stroke="currentColor"
