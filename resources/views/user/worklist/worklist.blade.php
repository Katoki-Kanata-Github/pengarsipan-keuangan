                    ...
                    <div
                        ...
                        <div class="relative flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div
                                    class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-lg flex items-center justify-center ring-4 ring-white/30">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="relative bg-gradient-to-b from-[#003A8F] to-[#002766] px-6 py-5">
                                ...
                                <div class="relative flex items-center justify-between">
                                    ...
                                    <span
                                        ...
                                        {{ $my_pengajuan->where('status_kelengkapan', 'Belum Lengkap')->where('status_verifikasi', 0)->count() }}
                                        Item
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                @forelse ($my_pengajuan as $pengajuan)
                                    @if ($pengajuan->status_kelengkapan == 'Belum Lengkap' && $pengajuan->status_verifikasi == 0)
                                        <div
                                            class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all duration-300">
                                            <div
                                                class="absolute top-0 right-0 w-32 h-32 bg-blue-200 rounded-full opacity-20 blur-2xl -mr-16 -mt-16">
                                            </div>

                                            <div class="relative flex items-center p-5">
                                                {{-- Number Badge --}}
                                                <div
                                                    class="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-gradient-to-br from-blue-500 to-cyan-600 text-white font-bold text-lg rounded-xl shadow-lg ring-4 ring-blue-100">
                                                    {{ $no++ }}
                                                </div>
                                                ...
                                                <a href="{{ route('pengajuan.show', $pengajuan->id) }}"
                                                    ...
                                                    <div class="flex flex-wrap items-center gap-2">
                                                        <span
                                                            class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-700 border border-blue-300">
                                                        ...
                                                        @if ($pengajuan->status_kelengkapan == 'Belum Lengkap')
                                                            <span
                                                                class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 border border-yellow-300">
                                                        ...
                                                        <span
                                                            class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-700 border border-red-300">
                                                            <svg class="w-3 h-3 mr-1" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                        ...
                                                        @if ($pengajuan->status_dikembalikan == 1)
                                                            <span
                                                                class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 border border-yellow-300">
                                                                <svg class="w-3 h-3 mr-1" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        @if ($pengajuan->status_diarsipkan == 1)
                                                            <span
                                                                class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-700 border border-purple-300">
                                                                <svg class="w-3 h-3 mr-1" fill="none"
                                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                ...
                                                <div class="flex gap-2 flex-shrink-0">
                                                    ...
                                                    <form action="{{ route('pengajuan.destroy', $pengajuan->id) }}"
                                                        ...
                                                        @csrf
                                                        <button
                                                            class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white text-sm font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">
                                ...
                                @empty
                                    <div class="text-center py-12">
                                        <div
                                            class="w-20 h-20 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Pengajuan yang sedang diproses akan
                                            muncul di sini</p>
                                    </div>
                                @endforelse
                            </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                @forelse ($my_pengajuan as $pengajuan)
                                    <div
                                        class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-slate-50 border-2 border-gray-200 hover:border-gray-400 hover:shadow-lg transition-all duration-300">
                                        <div
                                            class="absolute top-0 right-0 w-32 h-32 bg-gray-200 rounded-full opacity-20 blur-2xl -mr-16 -mt-16">
                                        </div>

                                        <div class="relative flex items-center p-5">
                                            {{-- Number Badge --}}
                                            <div
                                                class="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-gradient-to-b from-[#003A8F] to-[#002766] text-white font-bold text-sm rounded-xl shadow-lg ring-4 ring-gray-100">
                                                {{ $no++ }}
                                            </div>
                                            ...
                                            <a href="{{ route('pengajuan.show', $pengajuan->id) }}"
                                                ...
                                                <div class="flex flex-wrap items-center gap-2">
                                                    ...
                                                    @elseif($pengajuan->status_kelengkapan == 'Lengkap')
                                                        <span
                                                            class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-700 border border-green-300">
                                                            <svg class="w-3 h-3 mr-1" fill="none"
                                                                stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                            ...
                                            {{-- Action Buttons --}}
                                            @if (!$pengajuan->status_diarsipkan)
                                                <div class="flex justify-center gap-3">
                                                    ...
                                                    <a href="{{ route('pengajuan.edit', $pengajuan->id) }}"
                                                        ...
                                                        title="Edit User">
                                                        <svg class="w-5 h-5 text-white group-hover/btn:rotate-12 transition-transform duration-300"
                                ...
                                @empty
                                    <div class="text-center py-12">
                                        <div
                                            class="w-20 h-20 bg-gradient-to-br from-gray-100 to-slate-100 rounded-full flex items-center justify-center mx-auto mb-4 shadow-inner">
                            ...
                            <div class="relative bg-gradient-to-b from-[#003A8F] to-[#002766] px-6 py-5">
                                ...
                                <div class="relative flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <h3 class="text-lg font-semibold text-white">Pengajuan Diverifikasi atau
                                            Selesai</h3>
                                    </div>
                                    <span
                                        class="px-3 py-1 bg-white/20 backdrop-blur-sm text-white text-sm font-semibold rounded-full">
